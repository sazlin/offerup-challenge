...
SECRET_KEY = '(wyjydv#e_jlqa!0*tg+_8@xws+_zjn4_wqs+ckvd4%ap!x17-'
...
ROOT_URLCONF = 'offerup_challenge_site.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'offerup_challenge_site.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = os.environ['OFFERUP_CHALLENGE_S3_BUCKET_NAME']
